...
public class BleUtils {
	...
	public static Map<String, BtDevice> selectedMap;
	public static List<BtDevice> selectDevices;
	...
	public void connect(String address) {
		...
		if (mBluetoothLeService != null) {
			mBluetoothLeService.connect(address);
				...
				// TODO: 设置任务队列，当重新连接上的时候一次执行任务
			bindservice();
		}
	}

	public void connect(List<BtDevice> devices) {

		BleUtils.selectDevices.addAll(devices);

		if (mBluetoothLeService != null) {
			mBluetoothLeService.connect(devices);
		}
