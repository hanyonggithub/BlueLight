...
//    private String where =  "mime_type in ('audio/mpeg','audio/x-ms-wma') and bucket_display_name <> 'audio' and is_music > 0 " ;  
    private String where =  MediaStore.Audio.Media.IS_MUSIC + "!= 0" ;  
...
//            int displayNameCol = cursor.getColumnIndex(Media.DISPLAY_NAME);
        	int displayNameCol = cursor.getColumnIndex(MediaStore.Audio.AudioColumns.TITLE);
//        	int displayNameCol = cursor.getColumnIndex(MediaStore.Audio.AudioColumns.DISPLAY_NAME);
