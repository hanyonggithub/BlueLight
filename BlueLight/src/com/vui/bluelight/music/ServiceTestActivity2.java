...
public class ServiceTestActivity2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvw_display_visualizer = (TextView) findViewById(R.id.tvw_display_visualizer);
		mVisualizerView = (VisualizerView) findViewById(R.id.visualizer);
		intent = new Intent(ServiceTestActivity2.this, MusicService.class);
		startService(new Intent(ServiceTestActivity2.this, MusicService.class));
		bindService(intent, conn, Context.BIND_AUTO_CREATE);
		tvw_play.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				if (isPlay) {
					stopService(new Intent(ServiceTestActivity2.this, MusicService.class));
					isPlay = false;
				} else {
